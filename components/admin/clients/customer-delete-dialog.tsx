...
import { deleteCustomerAction } from "@/actions/admin/customer";
...
interface Props {
  ...
  customerId: string;
  /** Nom complet à re-taper pour confirmer (insensible à la casse + accents). */
  customerName: string;
}
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          <div className="rounded-md border border-red-200 bg-red-50 p-3 text-sm text-red-700 space-y-1">
            ...
            <p className="text-xs">
              Le client, <strong>toutes ses réservations</strong>, ses
              <strong> devis</strong>, ses{" "}
              <strong>pièces justificatives</strong> (permis, ID…), ses{" "}
              <strong>factures, contrats et états des lieux</strong> seront
